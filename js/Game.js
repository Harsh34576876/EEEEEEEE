class Game {
  ...
  start() {
    ...
    var obstacle2Positions = [
      { x: width / 2 - 121, y: height - 1301, image: obstacle2Image },
      { x: width / 2 + 251, y: height - 1801, image: obstacle2Image },
      { x: width / 2 - 181, y: height - 3201, image: obstacle2Image },
     
      { x: width / 2 - 151, y: height - 4301, image: obstacle2Image },
      { x: width / 2, y: height - 5301, image: obstacle2Image },
    ];
